...
export class ImageCard extends Component {
    state = {
        ...
        redirectPage:'', AssetID:'', redirectEditPage:'',classDeploy:'',redirectDeployPage:'',redirectDetailPage:'',governance:'N'
      }
      componentDidMount() {
    ...
    render() {
      if(this.state.redirectEditPage){
        ...
        return <Redirect push to={"/AssetManagement?" + this.state.EditAssetID+"&governanceTab=Y"} />; 
    }
                                    ...
                                    {AssetUnderReviewnew.map((AssetUnderReview,index)=> 
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td class="review_tab"><a className="link-xs" href="javscript:void(0);" onClick={this.handleView(AssetUnderReview.ASSET_ID)}>REVIEW</a>&nbsp; &nbsp; &nbsp; <a className="link-xs" href="javscript:void(0);" onClick={this.handleEdit(AssetUnderReview.ASSET_ID)}>EDIT</a></td>
                                            </>
                                    ...
                                    {PendingRectificationnew.map((PendingRectification,index)=> 
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td class="review_tab"><a className="link-xs" href="javscript:void(0);" onClick={this.handleView(PendingRectification.ASSET_ID)}>REVIEW</a>&nbsp; &nbsp; &nbsp; <a className="link-xs" href="javscript:void(0);" onClick={this.handleEdit(PendingRectification.ASSET_ID)}>EDIT</a></td>
                                    ...
                                    {AssetLivenew.map((AssetLive,index)=> 
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td class="review_tab"><a className="link-xs" href="javscript:void(0);" onClick={this.handleView(AssetLive.ASSET_ID)}>REVIEW</a>&nbsp; &nbsp; &nbsp; <a className="link-xs" href="javscript:void(0);" onClick={this.handleEdit(AssetLive.ASSET_ID)}>EDIT</a></td>
                                    ...
                                    {AssetRejectednew.map((AssetRejected,index)=> 
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td class="review_tab"><a className="link-xs" href="javscript:void(0);" onClick={this.handleView(AssetRejected.ASSET_ID)}>VIEW</a>&nbsp; &nbsp; &nbsp; <a className="link-xs"  href="javscript:void(0);" onClick={this.handleEdit(AssetRejected.ASSET_ID)}>EDIT</a></td>
