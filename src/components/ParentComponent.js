...
class ParentComponent extends Component {
    ...
    ListOnChange = (data) => {
        ...
        // alert(global.selectedDropdownContract +"parentComponent");
        this.setState({
            disabledUI: true
        })
        if (data != "") {
        ...
        // global.selectedSortOption= ValSortBy;

        // global.Last Updated
        // document.getElementById('dropdown-basic').innerHTML = ValSortBy;
    ...
    sortOnChange = (data) => {
        ...
        if(document.getElementById('Loader')){
            setTimeout(function(){document.getElementById('Loader').classList.remove('hide');}, 500);
        }
    ...
    render() {
        ...
        return (
            <div className="App">
                  ...
                  {((localStorage.getItem("user_email") != undefined) && (localStorage.getItem("user_email") != null) && (localStorage.getItem("user_email") != 'null') && (localStorage.getItem("user_email") != "")) &&
        <>
                <DIALOG />
                    ...
                    <Container fluid={true}>
                        <Row>
                            ...
                            <Col md={12} className="mb-12 text-center"> <strong >{this.state.errorMsg}</strong></Col>
                                ...
                                <Loader />
                                <ImageCard onClick={this.winOnChange.bind(this)}/>
                            </Col>
                        </Row>
                    </Container>
                    <Footer />
