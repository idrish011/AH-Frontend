        ...
        if(url.indexOf('?') != -1){
          ...
          .then(res => {
            ...
            if(other_filters.LOB.length > 0){
                LOBValue = Object.keys(other_filters.LOB[0])[0];
            }
            var ImperativeValue= '';
            if(other_filters.Imperative.length > 0){
                ImperativeValue = Object.keys(other_filters.Imperative[0])[0];
            }
            var SolAreaFilterID = '';
            ...
            if(res.data.WINSTORY_THUMBNAIL!=""){
                ...
                else if(thumbnailURL.contains('png')){
                    imagetype = 'png';
                } 
                let img = new Image();
                img.src = res.data.WINSTORY_THUMBNAIL ;
                var myFILE = new Blob([img], {type:`image/${imagetype}`});
